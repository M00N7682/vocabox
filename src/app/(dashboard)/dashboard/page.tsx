      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-4 p-5 bg-white rounded-xl border border-eo-border">
          ...
          <div className="flex flex-col">
            {data.recentAssessments.length > 0 ? data.recentAssessments.map((r, i) => (
              <Link key={r.id} href={`/assessments/${r.id}`} className={`flex items-center gap-2 py-3 hover:bg-eo-bg-surface rounded-lg px-2 -mx-2 transition-colors ${i < data.recentAssessments.length - 1 ? "border-b border-eo-border" : ""}`}>
        ...
        <div className="flex flex-col gap-4 p-5 bg-white rounded-xl border border-eo-border">
          <div className="flex items-center justify-between">
            ...
            <Link href="/attendance" className="text-[13px] font-medium text-eo-primary">전체 보기 →</Link>
          </div>
      ...
      {data.textbookProgress.length > 0 && (
        <div className="flex flex-col gap-4 p-5 bg-white rounded-xl border border-eo-border">
          <div className="flex items-center justify-between">
            ...
            <Link href="/textbooks" className="text-[13px] font-medium text-eo-primary">전체 보기 →</Link>
          </div>
